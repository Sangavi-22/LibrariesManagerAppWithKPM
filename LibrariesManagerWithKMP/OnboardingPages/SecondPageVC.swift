...
class SecondPageVC: UIViewController {
    ...
    let imageView: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: "Onboarding Page 2")
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if !(animationHasBeenShown){
            textLabel.animateLabelText(stringToAnimate: "Borrow books and get it delivered at your door step", delay: 0.06)
    ...
    func setConstraintsToSubviews(){
        ...
        landscapeConstraints = [
            textLabel.topAnchor.constraint(equalTo: view.topAnchor, constant: 5),
            ...
            imageView.topAnchor.constraint(equalTo: textLabel.bottomAnchor),
